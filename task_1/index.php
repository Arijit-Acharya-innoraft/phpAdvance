  ...
  <?php
    ...
    */
    ...
    class FetchData {
       ...
       * @param $url is used for getting the url of api.
       ...
       * @param $main_response_data is used to collect the json decoded response from where we shall obtain the data.
       */
      function storing_value($main_response_data) {
        ...
        for ($i = 0; $i < $len; $i++) {
          ...
          $image_response_data = $this->get_data($image_get_api);
          ...
          $explore_link_data = $this->get_data($explore_link_get_api);
     ...
     */
    $api = new FetchData;
    $main_response_data = $api->get_data($url_main);
    $api->storing_value($main_response_data);
  ?>
</body>
